...
public class UnitOfWork : IUnitOfWork,IDisposable
{
    ...
    private IDetalleMovInventarioRepository _DetalleMovInventarios;
    ...
    private ITipoMovInventarioRepository _TipoMovInventarios;
    ...
    public UnitOfWork(FarmaciaAppContext context)
    {
        _context = context;
    }
    ...
    public IDetalleMovInventarioRepository DetalleMovInventarios
    {
        get
        {
            ...
            {
                _DetalleMovInventarios = new DetalleMovInventarioRepository (_context); // Remember putting the base in the repository of this entity
            }
    ...
    public ITipoMovInventarioRepository TipoMovInventarios
    {
        get
        {
